 ...
 * which say that the managed entity is an Customer and the primary key is of type Long
 * With these 2 types, the JpaRepository builds all the required queries to CRUD the 
 * records in the database.
 * 
 * There is no requirement to add the Customer entity to a persistence file
